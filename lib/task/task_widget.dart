      ...
      child: Scaffold(
        ...
        body: Stack(
          children: [
              ...
              children: [
                                          ...
                                          itemBuilder:
                                            ...
                                            return InkWell(
                                              ...
                                              child: wrapWithModel(
                                                ...
                                                child: Task1Widget(
                                                  key: Key(
                                                    'Key1a9_${listViewTasksRecord.title}',
                                                  ),
                                                  taskDocument:
                                                      listViewTasksRecord,
                                                  checkAction: () async {
                ...
                Opacity(
                  ...
                  child: Align(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        _model.apiResultjxg = await InspritationalCall.call();

                        if ((_model.apiResultjxg?.succeeded ?? true)) {
                          _model.apistring = getJsonField(
                            (_model.apiResultjxg?.jsonBody ?? ''),
                            r'''$[0].q''',
                          ).toString();
            ...
            Align(
              alignment: AlignmentDirectional(-0.07, 0.67),
              child: Text(
                _model.author,
                style: FlutterFlowTheme.of(context).bodyMedium.override(
                      font: GoogleFonts.inter(
