...
class _AddTaskWidgetState extends State<AddTaskWidget> {
  ...
  void initState() {
    ...
    _model.tileTextTextController ??= TextEditingController();
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              width: double.infinity,
              child: TextFormField(
                controller: _model.tileTextTextController,
                focusNode: _model.tileTextFocusNode,
                autofocus: false,
                enabled: true,
                obscureText: false,
                ...
                validator:
                    _model.tileTextTextControllerValidator.asValidator(context),
              ),
            ),
            TextFormField(
              ...
              enableInteractiveSelection: true,
              validator:
                  _model.dESCRIPTextControllerValidator.asValidator(context),
            ),
            FFButtonWidget(
              onPressed: () async {
                await TasksRecord.collection.doc().set(createTasksRecordData(
                      title: valueOrDefault<String>(
                        _model.tileTextTextController.text,
                        'title',
                      ),
                      details: _model.dESCRIPTextController.text,
                      completed: false,
